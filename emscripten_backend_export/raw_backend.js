  ...
  onDrop:(event) => {
        ...
        function save(file) {
          ...
          reader.onloadend = (e) => {
            ...
            if (++written === count) {
              ((a1, a2, a3) => getWasmTableEntry(GLFW.active.dropFunc).call(null, BigInt(a1), a2, a3))(GLFW.active.id, count, filenames);
          ...
          HEAPU64[((filenames + i*4)/8)] = BigInt(filename);
        }
