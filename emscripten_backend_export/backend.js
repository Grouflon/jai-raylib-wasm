...
(function() {
  ...
  if (currentNodeVersion < 230000) {
    throw new Error(`This emscripten-generated code requires node v${ packedVersionToHumanReadable(230000) } (detected v${packedVersionToHumanReadable(currentNodeVersion)})`);
  }
...
// Begin JS library code
  ...
  onKeyPress:(event) => {
        ...
        ((a1, a2) => dynCall_vji(GLFW.active.charFunc, BigInt(a1), a2))(GLFW.active.id, charCode);
      },
  onKeyChanged:(keyCode, status) => {
        ...
        if (GLFW.active.keyFunc) {
          ...
          ((a1, a2, a3, a4, a5) => dynCall_vjiiii(GLFW.active.keyFunc, BigInt(a1), a2, a3, a4, a5))(GLFW.active.id, key, keyCode, status, GLFW.getModBits(GLFW.active));
        }
      },
  ...
  onMousemove:(event) => {
        ...
        if (GLFW.active.cursorPosFunc) {
          ((a1, a2, a3) => dynCall_vjdd(GLFW.active.cursorPosFunc, BigInt(a1), a2, a3))(GLFW.active.id, Browser.mouseX, Browser.mouseY);
        }
      },
  ...
  onMouseenter:(event) => {
        ...
        if (GLFW.active.cursorEnterFunc) {
          ((a1, a2) => dynCall_vji(GLFW.active.cursorEnterFunc, BigInt(a1), a2))(GLFW.active.id, 1);
        }
      },
  onMouseleave:(event) => {
        if (!GLFW.active) return;
        ...
        if (GLFW.active.cursorEnterFunc) {
          ((a1, a2) => dynCall_vji(GLFW.active.cursorEnterFunc, BigInt(a1), a2))(GLFW.active.id, 0);
        }
      },
  onMouseButtonChanged:(event, status) => {
        ...
        if (GLFW.active.mouseButtonFunc) {
          ((a1, a2, a3, a4) => dynCall_vjiii(GLFW.active.mouseButtonFunc, BigInt(a1), a2, a3, a4))(GLFW.active.id, eventButton, status, GLFW.getModBits(GLFW.active));
        }
      },
  ...
  onMouseWheel:(event) => {
        ...
        ((a1, a2, a3) => dynCall_vjdd(GLFW.active.scrollFunc, BigInt(a1), a2, a3))(GLFW.active.id, sx, sy);
  ...
  onWindowSizeChanged:() => {
        ...
        if (GLFW.active.windowSizeFunc) {
          ((a1, a2, a3) => dynCall_vjii(GLFW.active.windowSizeFunc, BigInt(a1), a2, a3))(GLFW.active.id, GLFW.active.width, GLFW.active.height);
        }
      },
  onFramebufferSizeChanged:() => {
        ...
        if (GLFW.active.framebufferSizeFunc) {
          ((a1, a2, a3) => dynCall_vjii(GLFW.active.framebufferSizeFunc, BigInt(a1), a2, a3))(GLFW.active.id, GLFW.active.framebufferWidth, GLFW.active.framebufferHeight);
        }
      },
  onWindowContentScaleChanged:(scale) => {
        ...
        if (GLFW.active.windowContentScaleFunc) {
          ((a1, a2, a3) => dynCall_vjff(GLFW.active.windowContentScaleFunc, BigInt(a1), a2, a3))(GLFW.active.id, GLFW.scale, GLFW.scale);
        }
      },
          ...
          for (var joy = 0; joy < GLFW.lastGamepadState.length; ++joy) {
            ...
            if (gamepad) {
              ...
              for (var i = 0; i < gamepad.axes.length; ++i) {
                HEAPF32[((data.axes + i*4)/4)] = gamepad.axes[i];
              }
            } else {
              if (GLFW.joys[joy]) {
  ...
  onDrop:(event) => {
        ...
        var filenames = _malloc(event.dataTransfer.files.length * 8);
        var filenamesArray = [];
        ...
        function save(file) {
          ...
          reader.onloadend = (e) => {
            ...
            if (++written === count) {
              ((a1, a2, a3) => dynCall_vjij(GLFW.active.dropFunc, BigInt(a1), a2, BigInt(a3)))(GLFW.active.id, count, filenames);
  ...
  getCursorPos:(winid, x, y) => {
        HEAPF64[((x)/8)] = Browser.mouseX;
        HEAPF64[((y)/8)] = Browser.mouseY;
      },
  getMousePos:(winid, x, y) => {
        HEAP32[((x)/4)] = Browser.mouseX;
        HEAP32[((y)/4)] = Browser.mouseY;
      },
  ...
  destroyWindow:(winid) => {
        ...
        if (win.windowCloseFunc) {
          ((a1) => abort('Internal Error! Attempted to invoke wasm function pointer with signature "vj", but no such functions have gotten exported!'))(win.id);
        }
  ...
  var _glfwCreateWindow = (width, height, title, monitor, share) => {
    title = bigintToI53Checked(title);
    monitor = bigintToI53Checked(monitor);
    share = bigintToI53Checked(share);
  
  return BigInt(GLFW.createWindow(width, height, title, monitor, share));
  };
  ...
  function _glfwDestroyWindow(winid) {
    winid = bigintToI53Checked(winid);
  
  return GLFW.destroyWindow(winid);
  }

  
  var _glfwGetPrimaryMonitor = () => 1n;;

  var _glfwGetTime = () => GLFW.getTime() - GLFW.initialTime;

  
  var _glfwGetVideoModes = function(monitor, count) {
    monitor = bigintToI53Checked(monitor);
    count = bigintToI53Checked(count);
  ...
  var _glfwSetCharCallback = (winid, cbfun) => {
    winid = bigintToI53Checked(winid);
    cbfun = bigintToI53Checked(cbfun);
  
  return BigInt(GLFW.setCharCallback(winid, cbfun));
  };

  
  var _glfwSetCursorEnterCallback = function(winid, cbfun) {
    winid = bigintToI53Checked(winid);
    cbfun = bigintToI53Checked(cbfun);
  ...
  return BigInt(GLFW.setCursorPosCallback(winid, cbfun));
  };

  
  var _glfwSetDropCallback = (winid, cbfun) => {
    winid = bigintToI53Checked(winid);
    cbfun = bigintToI53Checked(cbfun);
  
  return BigInt(GLFW.setDropCallback(winid, cbfun));
  };

  
  var _glfwSetErrorCallback = function(cbfun) {
    cbfun = bigintToI53Checked(cbfun);
  ...
  var _glfwSetKeyCallback = (winid, cbfun) => {
    winid = bigintToI53Checked(winid);
    cbfun = bigintToI53Checked(cbfun);
  
  return BigInt(GLFW.setKeyCallback(winid, cbfun));
  };
  ...
  return BigInt(GLFW.setMouseButtonCallback(winid, cbfun));
  };
  ...
  return BigInt(GLFW.setScrollCallback(winid, cbfun));
  };

  
  var _glfwSetWindowContentScaleCallback = function(winid, cbfun) {
    winid = bigintToI53Checked(winid);
    cbfun = bigintToI53Checked(cbfun);
  ...
  var _glfwSetWindowFocusCallback = function(winid, cbfun) {
    winid = bigintToI53Checked(winid);
    cbfun = bigintToI53Checked(cbfun);
  ...
  var _glfwSetWindowIconifyCallback = function(winid, cbfun) {
    winid = bigintToI53Checked(winid);
    cbfun = bigintToI53Checked(cbfun);
  ...
  return BigInt(GLFW.setWindowSizeCallback(winid, cbfun));
  };
...
var ASM_CONSTS = {
  87632: () => { if (document.fullscreenElement) return 1; },  
 87678: () => { return document.getElementById('canvas').width; },  
 87730: () => { return parseInt(document.getElementById('canvas').style.width); },  
 87798: () => { document.exitFullscreen(); },  
 87825: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 87898: () => { if (document.fullscreenElement) return 1; },  
 87944: () => { return document.getElementById('canvas').width; },  
 87996: () => { return screen.width; },  
 88021: () => { document.exitFullscreen(); },  
 88048: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 88181: () => { return window.innerWidth; },  
 88207: () => { return window.innerHeight; },  
 88234: () => { if (document.fullscreenElement) return 1; },  
 88280: () => { return document.getElementById('canvas').width; },  
 88332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 88400: () => { if (document.fullscreenElement) return 1; },  
 88446: () => { return document.getElementById('canvas').width; },  
 88498: () => { return screen.width; },  
 88523: () => { return window.innerWidth; },  
 88549: () => { return window.innerHeight; },  
 88576: () => { if (document.fullscreenElement) return 1; },  
 88622: () => { return document.getElementById('canvas').width; },  
 88674: () => { return screen.width; },  
 88699: () => { document.exitFullscreen(); },  
 88726: () => { if (document.fullscreenElement) return 1; },  
 88772: () => { return document.getElementById('canvas').width; },  
 88824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 88892: () => { document.exitFullscreen(); },  
 88919: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 88977: () => { return screen.width; },  
 89002: () => { return screen.height; },  
 89028: () => { return window.screenX; },  
 89055: () => { return window.screenY; },  
 89082: () => { return window.devicePixelRatio; },  
 89118: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 89171: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 89242: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 89299: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 89555: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 89626: () => { if (document.fullscreenElement) return 1; },  
 89672: () => { return window.innerWidth; },  
 89698: () => { return window.innerHeight; },  
 89725: () => { if (document.pointerLockElement) return 1; }
};
...
var dynCall_vij = Module['dynCall_vij'] = makeInvalidEarlyAccess('dynCall_vij');
var dynCall_vjii = Module['dynCall_vjii'] = makeInvalidEarlyAccess('dynCall_vjii');
var dynCall_vji = Module['dynCall_vji'] = makeInvalidEarlyAccess('dynCall_vji');
var dynCall_vjij = Module['dynCall_vjij'] = makeInvalidEarlyAccess('dynCall_vjij');
var dynCall_vjff = Module['dynCall_vjff'] = makeInvalidEarlyAccess('dynCall_vjff');
var dynCall_vjiiii = Module['dynCall_vjiiii'] = makeInvalidEarlyAccess('dynCall_vjiiii');
var dynCall_vjiii = Module['dynCall_vjiii'] = makeInvalidEarlyAccess('dynCall_vjiii');
var dynCall_vjdd = Module['dynCall_vjdd'] = makeInvalidEarlyAccess('dynCall_vjdd');
var dynCall_jj = Module['dynCall_jj'] = makeInvalidEarlyAccess('dynCall_jj');
var dynCall_iijj = Module['dynCall_iijj'] = makeInvalidEarlyAccess('dynCall_iijj');
var dynCall_vjji = Module['dynCall_vjji'] = makeInvalidEarlyAccess('dynCall_vjji');
...
var dynCall_viiiji = Module['dynCall_viiiji'] = makeInvalidEarlyAccess('dynCall_viiiji');
var dynCall_vffff = Module['dynCall_vffff'] = makeInvalidEarlyAccess('dynCall_vffff');
var dynCall_vijji = Module['dynCall_vijji'] = makeInvalidEarlyAccess('dynCall_vijji');
var dynCall_vijjj = Module['dynCall_vijjj'] = makeInvalidEarlyAccess('dynCall_vijjj');
var dynCall_vf = Module['dynCall_vf'] = makeInvalidEarlyAccess('dynCall_vf');
var dynCall_viiiiiiij = Module['dynCall_viiiiiiij'] = makeInvalidEarlyAccess('dynCall_viiiiiiij');
var dynCall_viiiiiiiij = Module['dynCall_viiiiiiiij'] = makeInvalidEarlyAccess('dynCall_viiiiiiiij');
...
var dynCall_viiij = Module['dynCall_viiij'] = makeInvalidEarlyAccess('dynCall_viiij');
...
var dynCall_viiijjjj = Module['dynCall_viiijjjj'] = makeInvalidEarlyAccess('dynCall_viiijjjj');
var dynCall_viijj = Module['dynCall_viijj'] = makeInvalidEarlyAccess('dynCall_viijj');
var dynCall_iij = Module['dynCall_iij'] = makeInvalidEarlyAccess('dynCall_iij');
var dynCall_ji = Module['dynCall_ji'] = makeInvalidEarlyAccess('dynCall_ji');
var dynCall_viiiiiij = Module['dynCall_viiiiiij'] = makeInvalidEarlyAccess('dynCall_viiiiiij');
var dynCall_vfi = Module['dynCall_vfi'] = makeInvalidEarlyAccess('dynCall_vfi');
var dynCall_vijiji = Module['dynCall_vijiji'] = makeInvalidEarlyAccess('dynCall_vijiji');
...
var dynCall_viiiiij = Module['dynCall_viiiiij'] = makeInvalidEarlyAccess('dynCall_viiiiij');
var dynCall_vfff = Module['dynCall_vfff'] = makeInvalidEarlyAccess('dynCall_vfff');
var dynCall_jjji = Module['dynCall_jjji'] = makeInvalidEarlyAccess('dynCall_jjji');
var dynCall_jjjj = Module['dynCall_jjjj'] = makeInvalidEarlyAccess('dynCall_jjjj');
var dynCall_ij = Module['dynCall_ij'] = makeInvalidEarlyAccess('dynCall_ij');
var dynCall_ijdiiii = Module['dynCall_ijdiiii'] = makeInvalidEarlyAccess('dynCall_ijdiiii');
var dynCall_vjj = Module['dynCall_vjj'] = makeInvalidEarlyAccess('dynCall_vjj');
...
function assignWasmExports(wasmExports) {
  ...
  assert(wasmExports['dynCall_vij'], 'missing Wasm export: dynCall_vij');
  dynCall_vij = dynCalls['vij'] = Module['dynCall_vij'] = createExportWrapper('dynCall_vij', 3);
  assert(wasmExports['dynCall_vjii'], 'missing Wasm export: dynCall_vjii');
  dynCall_vjii = dynCalls['vjii'] = Module['dynCall_vjii'] = createExportWrapper('dynCall_vjii', 4);
  assert(wasmExports['dynCall_vji'], 'missing Wasm export: dynCall_vji');
  dynCall_vji = dynCalls['vji'] = Module['dynCall_vji'] = createExportWrapper('dynCall_vji', 3);
  assert(wasmExports['dynCall_vjij'], 'missing Wasm export: dynCall_vjij');
  dynCall_vjij = dynCalls['vjij'] = Module['dynCall_vjij'] = createExportWrapper('dynCall_vjij', 4);
  assert(wasmExports['dynCall_vjff'], 'missing Wasm export: dynCall_vjff');
  dynCall_vjff = dynCalls['vjff'] = Module['dynCall_vjff'] = createExportWrapper('dynCall_vjff', 4);
  assert(wasmExports['dynCall_vjiiii'], 'missing Wasm export: dynCall_vjiiii');
  dynCall_vjiiii = dynCalls['vjiiii'] = Module['dynCall_vjiiii'] = createExportWrapper('dynCall_vjiiii', 6);
  assert(wasmExports['dynCall_vjiii'], 'missing Wasm export: dynCall_vjiii');
  dynCall_vjiii = dynCalls['vjiii'] = Module['dynCall_vjiii'] = createExportWrapper('dynCall_vjiii', 5);
  assert(wasmExports['dynCall_vjdd'], 'missing Wasm export: dynCall_vjdd');
  dynCall_vjdd = dynCalls['vjdd'] = Module['dynCall_vjdd'] = createExportWrapper('dynCall_vjdd', 4);
  assert(wasmExports['dynCall_jj'], 'missing Wasm export: dynCall_jj');
  dynCall_jj = dynCalls['jj'] = Module['dynCall_jj'] = createExportWrapper('dynCall_jj', 2);
  assert(wasmExports['dynCall_iijj'], 'missing Wasm export: dynCall_iijj');
  dynCall_iijj = dynCalls['iijj'] = Module['dynCall_iijj'] = createExportWrapper('dynCall_iijj', 4);
  assert(wasmExports['dynCall_vjji'], 'missing Wasm export: dynCall_vjji');
  dynCall_vjji = dynCalls['vjji'] = Module['dynCall_vjji'] = createExportWrapper('dynCall_vjji', 4);
  ...
  assert(wasmExports['dynCall_viij'], 'missing Wasm export: dynCall_viij');
  dynCall_viij = dynCalls['viij'] = Module['dynCall_viij'] = createExportWrapper('dynCall_viij', 4);
  ...
  assert(wasmExports['dynCall_viiiji'], 'missing Wasm export: dynCall_viiiji');
  dynCall_viiiji = dynCalls['viiiji'] = Module['dynCall_viiiji'] = createExportWrapper('dynCall_viiiji', 6);
  ...
  assert(wasmExports['dynCall_vijji'], 'missing Wasm export: dynCall_vijji');
  dynCall_vijji = dynCalls['vijji'] = Module['dynCall_vijji'] = createExportWrapper('dynCall_vijji', 5);
  assert(wasmExports['dynCall_vijjj'], 'missing Wasm export: dynCall_vijjj');
  dynCall_vijjj = dynCalls['vijjj'] = Module['dynCall_vijjj'] = createExportWrapper('dynCall_vijjj', 5);
  ...
  assert(wasmExports['dynCall_viiiiiiij'], 'missing Wasm export: dynCall_viiiiiiij');
  dynCall_viiiiiiij = dynCalls['viiiiiiij'] = Module['dynCall_viiiiiiij'] = createExportWrapper('dynCall_viiiiiiij', 9);
  assert(wasmExports['dynCall_viiiiiiiij'], 'missing Wasm export: dynCall_viiiiiiiij');
  dynCall_viiiiiiiij = dynCalls['viiiiiiiij'] = Module['dynCall_viiiiiiiij'] = createExportWrapper('dynCall_viiiiiiiij', 10);
  ...
  assert(wasmExports['dynCall_viiij'], 'missing Wasm export: dynCall_viiij');
  dynCall_viiij = dynCalls['viiij'] = Module['dynCall_viiij'] = createExportWrapper('dynCall_viiij', 5);
  ...
  assert(wasmExports['dynCall_viiijjjj'], 'missing Wasm export: dynCall_viiijjjj');
  dynCall_viiijjjj = dynCalls['viiijjjj'] = Module['dynCall_viiijjjj'] = createExportWrapper('dynCall_viiijjjj', 8);
  assert(wasmExports['dynCall_viijj'], 'missing Wasm export: dynCall_viijj');
  dynCall_viijj = dynCalls['viijj'] = Module['dynCall_viijj'] = createExportWrapper('dynCall_viijj', 5);
  assert(wasmExports['dynCall_iij'], 'missing Wasm export: dynCall_iij');
  dynCall_iij = dynCalls['iij'] = Module['dynCall_iij'] = createExportWrapper('dynCall_iij', 3);
  assert(wasmExports['dynCall_ji'], 'missing Wasm export: dynCall_ji');
  dynCall_ji = dynCalls['ji'] = Module['dynCall_ji'] = createExportWrapper('dynCall_ji', 2);
  assert(wasmExports['dynCall_viiiiiij'], 'missing Wasm export: dynCall_viiiiiij');
  dynCall_viiiiiij = dynCalls['viiiiiij'] = Module['dynCall_viiiiiij'] = createExportWrapper('dynCall_viiiiiij', 8);
  ...
  assert(wasmExports['dynCall_vijiji'], 'missing Wasm export: dynCall_vijiji');
  dynCall_vijiji = dynCalls['vijiji'] = Module['dynCall_vijiji'] = createExportWrapper('dynCall_vijiji', 6);
  ...
  assert(wasmExports['dynCall_viiiiij'], 'missing Wasm export: dynCall_viiiiij');
  dynCall_viiiiij = dynCalls['viiiiij'] = Module['dynCall_viiiiij'] = createExportWrapper('dynCall_viiiiij', 7);
  ...
  assert(wasmExports['dynCall_jjji'], 'missing Wasm export: dynCall_jjji');
  dynCall_jjji = dynCalls['jjji'] = Module['dynCall_jjji'] = createExportWrapper('dynCall_jjji', 4);
  assert(wasmExports['dynCall_jjjj'], 'missing Wasm export: dynCall_jjjj');
  dynCall_jjjj = dynCalls['jjjj'] = Module['dynCall_jjjj'] = createExportWrapper('dynCall_jjjj', 4);
  assert(wasmExports['dynCall_ij'], 'missing Wasm export: dynCall_ij');
  dynCall_ij = dynCalls['ij'] = Module['dynCall_ij'] = createExportWrapper('dynCall_ij', 2);
  assert(wasmExports['dynCall_ijdiiii'], 'missing Wasm export: dynCall_ijdiiii');
  dynCall_ijdiiii = dynCalls['ijdiiii'] = Module['dynCall_ijdiiii'] = createExportWrapper('dynCall_ijdiiii', 7);
  assert(wasmExports['dynCall_vjj'], 'missing Wasm export: dynCall_vjj');
  dynCall_vjj = dynCalls['vjj'] = Module['dynCall_vjj'] = createExportWrapper('dynCall_vjj', 3);
...
function applySignatureConversions(wasmExports) {
  ...
  wasmExports['dynCall_vjff'] = makeWrapper__p___(wasmExports['dynCall_vjff']);
  ...
  wasmExports['dynCall_vjdd'] = makeWrapper__p___(wasmExports['dynCall_vjdd']);
  ...
  wasmExports['dynCall_vii'] = makeWrapper__p__(wasmExports['dynCall_vii']);
  ...
  wasmExports['dynCall_viiii'] = makeWrapper__p____(wasmExports['dynCall_viiii']);
  wasmExports['dynCall_viiiji'] = makeWrapper__p_____(wasmExports['dynCall_viiiji']);
  wasmExports['dynCall_vffff'] = makeWrapper__p____(wasmExports['dynCall_vffff']);
  wasmExports['dynCall_vijji'] = makeWrapper__p____(wasmExports['dynCall_vijji']);
  wasmExports['dynCall_vijjj'] = makeWrapper__p____(wasmExports['dynCall_vijjj']);
  wasmExports['dynCall_vf'] = makeWrapper__p_(wasmExports['dynCall_vf']);
  wasmExports['dynCall_viiiiiiij'] = makeWrapper__p________(wasmExports['dynCall_viiiiiiij']);
  wasmExports['dynCall_viiiiiiiij'] = makeWrapper__p_________(wasmExports['dynCall_viiiiiiiij']);
  wasmExports['dynCall_viiiiiiii'] = makeWrapper__p________(wasmExports['dynCall_viiiiiiii']);
  wasmExports['dynCall_i'] = makeWrapper__p(wasmExports['dynCall_i']);
  wasmExports['dynCall_vff'] = makeWrapper__p__(wasmExports['dynCall_vff']);
  wasmExports['dynCall_viii'] = makeWrapper__p___(wasmExports['dynCall_viii']);
  wasmExports['dynCall_viiij'] = makeWrapper__p____(wasmExports['dynCall_viiij']);
  ...
  wasmExports['dynCall_viiijjjj'] = makeWrapper__p_______(wasmExports['dynCall_viiijjjj']);
  wasmExports['dynCall_viijj'] = makeWrapper__p____(wasmExports['dynCall_viijj']);
  ...
  wasmExports['dynCall_viiiiiij'] = makeWrapper__p_______(wasmExports['dynCall_viiiiiij']);
  wasmExports['dynCall_vfi'] = makeWrapper__p__(wasmExports['dynCall_vfi']);
  wasmExports['dynCall_vijiji'] = makeWrapper__p_____(wasmExports['dynCall_vijiji']);
  wasmExports['dynCall_viif'] = makeWrapper__p___(wasmExports['dynCall_viif']);
  wasmExports['dynCall_vif'] = makeWrapper__p__(wasmExports['dynCall_vif']);
  wasmExports['dynCall_viff'] = makeWrapper__p___(wasmExports['dynCall_viff']);
  wasmExports['dynCall_vifff'] = makeWrapper__p____(wasmExports['dynCall_vifff']);
  wasmExports['dynCall_viffff'] = makeWrapper__p_____(wasmExports['dynCall_viffff']);
  wasmExports['dynCall_viiiiij'] = makeWrapper__p______(wasmExports['dynCall_viiiiij']);
  wasmExports['dynCall_vfff'] = makeWrapper__p___(wasmExports['dynCall_vfff']);
