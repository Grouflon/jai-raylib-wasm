...
// Begin JS library code
  ...
  onKeyPress:(event) => {
        ...
        ((a1, a2) => getWasmTableEntry(GLFW.active.charFunc).call(null, BigInt(a1), a2))(GLFW.active.id, charCode);
      },
  onKeyChanged:(keyCode, status) => {
        ...
        if (GLFW.active.keyFunc) {
          ...
          ((a1, a2, a3, a4, a5) => getWasmTableEntry(GLFW.active.keyFunc).call(null, BigInt(a1), a2, a3, a4, a5))(GLFW.active.id, key, keyCode, status, GLFW.getModBits(GLFW.active));
        }
      },
  ...
  onMousemove:(event) => {
        ...
        if (GLFW.active.cursorPosFunc) {
          ((a1, a2, a3) => getWasmTableEntry(GLFW.active.cursorPosFunc).call(null, BigInt(a1), a2, a3))(GLFW.active.id, Browser.mouseX, Browser.mouseY);
        }
      },
  ...
  onMouseenter:(event) => {
        ...
        if (GLFW.active.cursorEnterFunc) {
          ((a1, a2) => getWasmTableEntry(GLFW.active.cursorEnterFunc).call(null, BigInt(a1), a2))(GLFW.active.id, 1);
        }
      },
  onMouseleave:(event) => {
        if (!GLFW.active) return;
        ...
        if (GLFW.active.cursorEnterFunc) {
          ((a1, a2) => getWasmTableEntry(GLFW.active.cursorEnterFunc).call(null, BigInt(a1), a2))(GLFW.active.id, 0);
        }
      },
  onMouseButtonChanged:(event, status) => {
        ...
        if (GLFW.active.mouseButtonFunc) {
          ((a1, a2, a3, a4) => getWasmTableEntry(GLFW.active.mouseButtonFunc).call(null, BigInt(a1), a2, a3, a4))(GLFW.active.id, eventButton, status, GLFW.getModBits(GLFW.active));
        }
      },
  ...
  onMouseWheel:(event) => {
        ...
        ((a1, a2, a3) => getWasmTableEntry(GLFW.active.scrollFunc).call(null, BigInt(a1), a2, a3))(GLFW.active.id, sx, sy);
  ...
  onWindowSizeChanged:() => {
        ...
        if (GLFW.active.windowSizeFunc) {
          ((a1, a2, a3) => getWasmTableEntry(GLFW.active.windowSizeFunc).call(null, BigInt(a1), a2, a3))(GLFW.active.id, GLFW.active.width, GLFW.active.height);
        }
      },
  onFramebufferSizeChanged:() => {
        ...
        if (GLFW.active.framebufferSizeFunc) {
          ((a1, a2, a3) => getWasmTableEntry(GLFW.active.framebufferSizeFunc).call(null, BigInt(a1), a2, a3))(GLFW.active.id, GLFW.active.framebufferWidth, GLFW.active.framebufferHeight);
        }
      },
  onWindowContentScaleChanged:(scale) => {
        ...
        if (GLFW.active.windowContentScaleFunc) {
          ((a1, a2, a3) => getWasmTableEntry(GLFW.active.windowContentScaleFunc).call(null, BigInt(a1), a2, a3))(GLFW.active.id, GLFW.scale, GLFW.scale);
        }
      },
  ...
  onDrop:(event) => {
        ...
        function save(file) {
          ...
          reader.onloadend = (e) => {
            ...
            if (++written === count) {
              ((a1, a2, a3) => getWasmTableEntry(GLFW.active.dropFunc).call(null, BigInt(a1), a2, BigInt(a3)))(GLFW.active.id, count, filenames);
  ...
  destroyWindow:(winid) => {
        ...
        if (win.windowCloseFunc) {
          ((a1) => getWasmTableEntry(win.windowCloseFunc).call(null, BigInt(a1)))(win.id);
        }
